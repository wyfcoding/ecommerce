...
import (
	...
	pb "github.com/wyfcoding/ecommerce/go-api/audit/v1"
	...
	grpcServer "github.com/wyfcoding/ecommerce/internal/audit/interfaces/grpc"
	httpServer "github.com/wyfcoding/ecommerce/internal/audit/interfaces/http"
...
type AppContext struct {
	...
	AppService *application.AuditService
...
func registerGRPC(s *grpc.Server, svc interface{}) {
	ctx := svc.(*AppContext)
	pb.RegisterAuditServiceServer(s, grpcServer.NewServer(ctx.AppService))
}
...
func initService(cfg interface{}, m *metrics.Metrics) (interface{}, func(), error) {
	...
	manager := application.NewAuditManager(repo, idGen, logging.Default().Logger)
	query := application.NewAuditQuery(repo)
	service := application.NewAuditService(manager, query)

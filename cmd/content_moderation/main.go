...
import (
	...
	grpcServer "github.com/wyfcoding/ecommerce/internal/content_moderation/interfaces/grpc"
	httpServer "github.com/wyfcoding/ecommerce/internal/content_moderation/interfaces/http"
...
const BootstrapName = "content_moderation"
...
func initService(cfg any, m *metrics.Metrics) (any, func(), error) {
	...
	mgr := application.NewModerationManager(repo, logging.Default().Logger)

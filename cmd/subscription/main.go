...
func initService(cfg any, m *metrics.Metrics) (any, func(), error) {
	...
	query := application.NewSubscriptionQuery(subscriptionRepo)
	manager := application.NewSubscriptionManager(subscriptionRepo, logger.Logger)
	subscriptionService := application.NewSubscriptionService(manager, query)

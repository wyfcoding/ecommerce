...
import (
	...
	"ecommerce/internal/subscription/data"
...
func main() {
	...
	var conf Config
	if _, err := toml.DecodeFile("../../configs/subscription.toml", &conf); err != nil {
	...
	err = db.AutoMigrate(&data.SubscriptionPlan{}, &data.UserSubscription{})
	if err != nil {
	...
	subscriptionRepo := data.NewSubscriptionRepo(dataRepo)
	subscriptionUsecase := biz.NewSubscriptionUsecase(subscriptionRepo)

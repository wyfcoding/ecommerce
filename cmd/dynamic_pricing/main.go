...
import (
	...
	pb "github.com/wyfcoding/ecommerce/go-api/dynamic_pricing/v1"
	...
	grpcServer "github.com/wyfcoding/ecommerce/internal/dynamic_pricing/interfaces/grpc"
	httpServer "github.com/wyfcoding/ecommerce/internal/dynamic_pricing/interfaces/http"
...
const BootstrapName = "dynamic_pricing"

type AppContext struct {
	Config     *configpkg.Config
	AppService *application.DynamicPricingService
...
func registerGRPC(s *grpc.Server, svc interface{}) {
	ctx := svc.(*AppContext)
	pb.RegisterDynamicPricingServiceServer(s, grpcServer.NewServer(ctx.AppService))
}
...
func initService(cfg interface{}, m *metrics.Metrics) (interface{}, func(), error) {
	...
	service := application.NewDynamicPricingService(repo, logging.Default().Logger)

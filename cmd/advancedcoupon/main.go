...
import (
	...
	"github.com/wyfcoding/ecommerce/internal/advancedcoupon/infrastructure/persistence"
	coupongrpc "github.com/wyfcoding/ecommerce/internal/advancedcoupon/interfaces/grpc"
	couponhttp "github.com/wyfcoding/ecommerce/internal/advancedcoupon/interfaces/http"
...
const BootstrapName = "advancedcoupon"

// IdempotencyPrefix 幂等性 Redis 键前缀
const IdempotencyPrefix = "advancedcoupon:idem"
...
func registerGRPC(s *grpc.Server, svc any) {
	ctx := svc.(*AppContext)
	pb.RegisterAdvancedCouponServiceServer(s, coupongrpc.NewServer(ctx.AdvancedCoupon))
}
...
func initService(cfg any, m *metrics.Metrics) (any, func(), error) {
	...
	advancedCouponRepo := persistence.NewAdvancedCouponRepository(db)
	...
	return &AppContext{
		Config:         c,
		AdvancedCoupon: advancedCouponService,
		Clients:        clients,
		Handler:        handler,
		Metrics:        m,
		Limiter:        rateLimiter,

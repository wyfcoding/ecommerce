...
import (
	...
	"ecommerce/internal/marketing/application"
	"ecommerce/internal/marketing/infrastructure/persistence"
	marketinghttp "ecommerce/internal/marketing/interfaces/http"
	"ecommerce/pkg/app"
...
func initService(cfg interface{}, m *metrics.Metrics) (interface{}, func(), error) {
	...
	// Application Layer
	service := application.NewMarketingService(repo, slog.Default())

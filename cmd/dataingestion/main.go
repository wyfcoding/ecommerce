...
import (
	...
	grpcServer "github.com/wyfcoding/ecommerce/internal/dataingestion/interfaces/grpc"
	httpServer "github.com/wyfcoding/ecommerce/internal/dataingestion/interfaces/http"
...
func registerGRPC(s *grpc.Server, svc any) {
	ctx := svc.(*AppContext)
	pb.RegisterDataIngestionServiceServer(s, grpcServer.NewServer(ctx.AppService))
}

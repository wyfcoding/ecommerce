...
func initService(cfg any, m *metrics.Metrics) (any, func(), error) {
	...
	query := application.NewDataIngestionQuery(ingestionRepo)
	manager := application.NewDataIngestionManager(ingestionRepo, logger.Logger)
	ingestionService := application.NewDataIngestionService(manager, query)

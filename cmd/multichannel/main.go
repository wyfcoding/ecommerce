...
func initService(cfg any, m *metrics.Metrics) (any, func(), error) {
	...
	query := application.NewChannelQuery(channelRepo)
	manager := application.NewChannelManager(channelRepo, logger.Logger)
	channelService := application.NewMultiChannelService(manager, query)

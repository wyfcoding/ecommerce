...
type AppContext struct {
	Config       *Config
	Optimization *application.OrderOptimizationService
...
func registerGRPC(s *grpc.Server, svc any) {
	ctx := svc.(*AppContext)
	pb.RegisterOrderOptimizationServiceServer(s, optimizationgrpc.NewServer(ctx.Optimization))
}
...
func initService(cfg any, m *metrics.Metrics) (any, func(), error) {
	...
	optimizationRepo := persistence.NewOrderOptimizationRepository(db)

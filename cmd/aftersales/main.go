...
import (
	...
	"ecommerce/internal/aftersales/data"
...
type DatabaseConfig struct {
	...
	Port     int    `toml:"port"`
	User     string `toml:"user"`	Password string `toml:"password"`	DBName   string `toml:"dbname"`
}
...
func main() {
	...
	var conf Config
	if _, err := toml.DecodeFile("../../configs/aftersales.toml", &conf); err != nil {
	...
	err = db.AutoMigrate(&data.ReturnRequest{}, &data.RefundRequest{})
	if err != nil {

...
func initService(cfg any, m *metrics.Metrics) (any, func(), error) {
	...
	query := application.NewGroupbuyQuery(groupbuyRepo)
	manager := application.NewGroupbuyManager(groupbuyRepo, idGenerator, logger.Logger)
	groupbuyService := application.NewGroupbuyService(manager, query)

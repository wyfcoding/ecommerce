...
const IdempotencyPrefix = "file:idem"
...
func registerGRPC(s *grpc.Server, svc any) {
	ctx := svc.(*AppContext)
	pb.RegisterFileServiceServer(s, filegrpc.NewServer(ctx.File))
}
...
func initService(cfg any, m *metrics.Metrics) (any, func(), error) {
	...
	fileRepo := persistence.NewFileRepository(db)
	...
	handler := filehttp.NewHandler(fileService, logger.Logger)

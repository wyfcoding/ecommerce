...
import (
	...
	"github.com/wyfcoding/ecommerce/internal/scheduler/infrastructure/messaging"
...
const IdempotencyPrefix = "scheduler:idem"
...
func registerGRPC(s *grpc.Server, ctx *AppContext) {
	pb.RegisterSchedulerServiceServer(s, schedulergrpc.NewServer(ctx.Scheduler))
}
...
func initService(cfg *Config, m *metrics.Metrics) (*AppContext, func(), error) {
	...
	handler := schedulerhttp.NewHandler(schedulerService, logger.Logger)

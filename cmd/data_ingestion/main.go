...
import (
	...
	pb "github.com/wyfcoding/ecommerce/go-api/data_ingestion/v1"
	...
	grpcServer "github.com/wyfcoding/ecommerce/internal/data_ingestion/interfaces/grpc"
	httpServer "github.com/wyfcoding/ecommerce/internal/data_ingestion/interfaces/http"
...
const BootstrapName = "data_ingestion"
...
func initService(cfg interface{}, m *metrics.Metrics) (interface{}, func(), error) {
	...
	service := application.NewDataIngestionService(repo, logging.Default().Logger)

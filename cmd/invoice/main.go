...
import (
	...
	"github.com/wyfcoding/ecommerce/internal/invoice/infrastructure"
	"github.com/wyfcoding/ecommerce/internal/invoice/interfaces"
...
func main() {
	...
	cfg := &Config{
		HTTPPort:    8082,
		GRPCPort:    9082,
		MySQLDSN:    "root:password@tcp(localhost:3306)/invoice?charset=utf8mb4&parseTime=True&loc=Local",
	...
	// 初始化仓储
	invoiceRepo := infrastructure.NewGormInvoiceRepository(db)

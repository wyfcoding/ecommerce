...
import (
	...
	"github.com/wyfcoding/ecommerce/pkg/config"    // 导入项目内定义的配置包。
	"github.com/wyfcoding/ecommerce/pkg/databases" // 导入项目内定义的数据库连接工厂。
	"github.com/wyfcoding/ecommerce/pkg/logging"   // 导入项目内定义的日志包。

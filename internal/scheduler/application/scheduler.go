...
type SchedulerService struct {
	Command *SchedulerCommandService
	Query   *SchedulerQueryService
}

// NewSchedulerService 创建调度服务门面实例。
func NewSchedulerService(command *SchedulerCommandService, query *SchedulerQueryService) *SchedulerService {

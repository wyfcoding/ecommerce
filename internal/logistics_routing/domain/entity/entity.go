...
type Carrier struct {
	...
	Type              string      `gorm:"type:varchar(32);not null;comment:类型" json:"type"` // express, standard, economy
...
// RouteOrder 路由订单 (Value Object stored in JSON)
...
// RouteOrderArray defines a slice of RouteOrder that implements sql.Scanner and driver.Valuer

...
import (
	...
	"github.com/wyfcoding/ecommerce/internal/dataprocessing/domain/entity"     // 导入数据处理模块的领域实体定义。
	"github.com/wyfcoding/ecommerce/internal/dataprocessing/domain/repository" // 导入数据处理模块的领域仓储接口。

...
import (
	...
	"github.com/wyfcoding/ecommerce/internal/dataprocessing/domain/entity"     // 导入数据处理领域的实体定义。
	"github.com/wyfcoding/ecommerce/internal/dataprocessing/domain/repository" // 导入数据处理领域的仓储接口。

...
func (m *DataProcessingCommandService) SubmitTask(ctx context.Context, name, taskType, config string, workflowID uint64) (*domain.ProcessingTask, error) {
...
func (m *DataProcessingCommandService) processTask(task *domain.ProcessingTask) {
...
func (m *DataProcessingCommandService) CreateWorkflow(ctx context.Context, name, description, steps string) (*domain.ProcessingWorkflow, error) {
...
func (m *DataProcessingCommandService) CancelTask(ctx context.Context, id uint64) error {
...
func (m *DataProcessingCommandService) UpdateWorkflow(ctx context.Context, id uint64, name, description, steps string) error {
...
func (m *DataProcessingCommandService) SetWorkflowActive(ctx context.Context, id uint64, active bool) error {
	workflow, err := m.repo.GetWorkflow(ctx, id)
	if err != nil {
		return err
	}

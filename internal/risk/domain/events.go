...
const (
	RiskAnalysisCreatedEventType    = "risk.analysis.created"
	BlacklistAddedEventType         = "risk.blacklist.added"
	BlacklistRemovedEventType       = "risk.blacklist.removed"
	UserBehaviorUpdatedEventType    = "risk.behavior.updated"
	DeviceFingerprintSavedEventType = "risk.device.saved"
)

...
type MultiChannelService struct {
	Command *MultiChannelCommandService
	Query   *MultiChannelQueryService
}

// NewMultiChannelService 创建多渠道服务门面实例。
func NewMultiChannelService(command *MultiChannelCommandService, query *MultiChannelQueryService) *MultiChannelService {

...
import (
	"context"
	"errors"
	"github.com/wyfcoding/ecommerce/internal/notification/domain/entity"     // 导入通知模块的领域实体定义。
	"github.com/wyfcoding/ecommerce/internal/notification/domain/repository" // 导入通知模块的领域仓储接口。

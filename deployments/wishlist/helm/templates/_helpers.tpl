...
helm.sh/chart: { include "wishlist.chart" . }
{ include "wishlist.selectorLabels" . }
{- if .Chart.AppVersion }
...
*/}
{- define "wishlist.serviceAccountName" -}
{- if .Values.serviceAccount.create }
{- default (include "wishlist.fullname" .) .Values.serviceAccount.name }
{- else }
